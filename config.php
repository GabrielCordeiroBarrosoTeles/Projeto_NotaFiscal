<?php
    ...
    $CompanyName = "Company Name"; // Nome da empresa que vai aparecer no rodape
    ...
    $CompanyTelephone = "(85) 90000-0000";
    $CompanyEmailAddress = "companyemail@gmail.com";
    ...
    $MessageToSendToTheCompany = "Olá,como posso te ajudar?"; // Mensagem predefinida que o usuario vai te mandar
